...
int main()
{
	...
	unsigned int grassPlaneIndices[]{
		0, 1, 2,
		0, 2, 3,
	};
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(grassPlaneVertices), grassPlaneVertices, GL_STATIC_DRAW);
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), nullptr);
	glEnableVertexAttribArray(0);
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (const void*) ( 3 * sizeof(float)));
	glEnableVertexAttribArray(1);

	unsigned int grassPlaneElementBuffer;
	glGenBuffers(1, &grassPlaneElementBuffer);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, grassPlaneElementBuffer);
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(grassPlaneIndices), grassPlaneIndices, GL_STATIC_DRAW);

	// load textures
	unsigned int cubeTexture = loadTexture("resource/img/marble.jpg");
	unsigned int floorTexture = loadTexture("resource/img/metal.png");
	unsigned int grassTexture = loadTexture("resource/img/grass.png");

	Shader shader("shader/chapter/3-advanced-opengl/blending/vertex.vert", "shader/chapter/3-advanced-opengl/blending/fragment-discard.frag");
	shader.use();
	...
	glDeleteVertexArrays(1, &grassPlaneVAO);
	glDeleteBuffers(1, &grassPlaneVBO);
	glDeleteBuffers(1, &grassPlaneElementBuffer);
